/*
  # Fix Username Handling in Profile Creation

  1. Changes
    - Fix username handling to store in auth.users correctly
    - Update profile creation to use username field properly
    - Remove display_name usage from metadata
  ...
  BEGIN
    ...
    WHILE current_try < max_retries LOOP
      BEGIN
        ...
        -- Update auth.users with the username
        UPDATE auth.users
